  ...
  $('#submit-button').click(function(){
      ...
      $.ajax({
            ...
            success: function(result) {
              ...
              for(i=0;i<fileNames.length;i++){
                tabs += ' <li class="tab col"><a class="brown lighten-3 black-text" href="#pass1tab'+i+'">ASSEMBLER PASS 1 OUTPUT</a></li>';
              }                    
              ...
              tabs += '<div class="row"><div class="col s12"><ul class="tabs tabs-fixed-width">';
              for(i=0;i<fileNames.length;i++){
                tabs += ' <li class="tab col"><a class="brown lighten-3 black-text" href="#pass2tab'+i+'">ASSEMBLER PASS 2 OUTPUT</a></li>';
              }                    
